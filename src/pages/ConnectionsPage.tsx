  ...
  return (
    <div className="connections-page">
      <PageHeader
        section="Connect"
        title="Connections"
        description="Sync health for every connected CRM. If someone edits the CRM while Tantira is updating it, we'll pause and ask you to pick which version to keep. Resolving it resumes the sync for that lead and clears it from the Attention Center."
      />
